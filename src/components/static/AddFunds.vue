<script>
import QA from './ui/QR.vue';
import Portal from './ui/Portal.vue';
export default {
    props: {
        store: Object,
    }, 
...
.box-add-funds{
    ...
    .welcome-group{
        display: grid;
        grid-template-columns: minmax(50px, 240px) auto;
        height: auto;
        gap: 40px;
        width: 100%;
        position: relative;
