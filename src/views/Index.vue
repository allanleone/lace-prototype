            ...
            .main-window
                ...
                h1.bold.animatedIntro
                    TransitionGroup(name="fade")
                        div(vv-if="stage == 1", :key="1") Hello
                        div.gradient(:key="2") Web3
                    ...
                    .stage-1
                        .content-column.animated.fadeIn.delay-4s
                            h1.bold.placeholder
                                ...
                                div.gradient Web3
                            h4
                                div.animated.fadeIn.delay-3-5s Choose an option to get started
                            .networks
                                div Compatible with
                                div 
                    ...
                    .stage-2(v-if="stage >= 2")
                            ...
                            .content-column
                                .timeline 
                                    ...
                                    //- .point.animated.fadeInUp.delay-0-5s(:class="stage >= 4 ? 'path-done' : ''")
                            ...
                            .content-column.animated.fadeIn.delay-1s
                                        ...
                                        //- div.col-input
                                            label.improve-input
                                                span
                                                    ...
                                                    span Help to improve Lace's user experience
                                                .info
                                ...
                                .content-stage.animated.toggleInUp(v-if="stage == 3")
                                    h2 Let's setup your new wallet
                                    br/
                                    .content-section
                                        span Choose a name to help you identify your wallet.
                                        label
                                            input(type="text", placeholder="Wallet name", v-model="walletName")/
                                    br/
                                    span  Set up your password
                                        ...
                                        label
                                            ...
                                            span(v-if="password.length > 0")
                                                .feedback-passwd(:class="password.length < 3 ? 'red' : 'green'") 
                                                    ...
                                                    span Add more numbers and characters.
                                                .feedback-passwd(:class="password.length < 5 ? 'red' : 'green'") 
                                                    ...
                                                    span Use a longer pattern with more turns.
                                                .feedback-passwd.green(:class="password.length < 7 ? 'red' : 'green'") 
                                                    ...
                                                    span Your password is super strong.
                                        label
                                            input(type="password", placeholder="Confirm Password", v-model="checkpassword")/
                                            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="ant-input-password-icon" data-testid="password-input-show-icon"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.512 12a9.004 9.004 0 0 0 16.977 0 9.004 9.004 0 0 0-16.977 0Zm-2.008-.3C2.906 7.238 7.074 4 12 4c4.927 0 9.095 3.238 10.497 7.7a1 1 0 0 1 0 .6C21.095 16.762 16.927 20 12 20c-4.927 0-9.095-3.238-10.497-7.7a1 1 0 0 1 0-.6ZM12 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-4 2a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z" fill="#878E9E"></path></svg>
                                            ...
                                            .feedback-passwd(v-if="checkpassword.length > 0")
                                                ...
                                                span
                                                    span.red(v-if="checkpassword.length < 5") Ops! the password don't match.
                                                    span.green(v-if="checkpassword.length >= 5") It's a match!.
                                //- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                                ...
                                .content-stage.animated.toggleInUp(v-if="stage == 4")
                                    ...
                                    .tabs 
                                        ...
                                        .tab(@click="tabRecovery = 3;", :class="tabRecovery == 3 ? 'active' : ''") 24-word
                                ...
                                .content-stage.animated.toggleInUp(v-if="stage == 5")
                                    h2 Hurray! All done :)
                                    .content-section
                                        span It's time to start your Web3 journey. Plus you can follow us to stay up to date on all our latest news and content.
                ...
                Transition(name="fade")
                    .modal-restore-overlay(v-if="popupRestore")
                        .background-overlay 
                        .floating-window
                            .title Restoring a multi-address wallet?
                            .desc If you're restoring a wallet created in another application, you may find some of your assets are not visible. Don't worry. Create a new wallet and send your assets to your new Lace wallet address and everything should be visible again.
                            .buttons 
                                button.tertiary(@click="popupRestore = false;") Cancel 
                                button.purple(@click="changeStageTo(2, false);") OK
                //- 
                //- 
                //- 
            //- 
