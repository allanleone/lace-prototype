...
.main#lace(:class="(showOrHideSidebarOnThisPage() == false ? 'no-widgets ' : ' ') + (showOrHideMainMenuOnThisPage() == false ? 'no-mainmenu ' : ' ')")
    ...
    .lang-selection(@click="langSelectionOpened = !langSelectionOpened")
        ...
        .list.animated.toggleInUp(v-if="langSelectionOpened")
            .item(@click="store.set({key: 'selectedLang', value: 'en'})", :class="store.get('selectedLang') == 'en' ? 'selected' : ''")
                .img
                    img(src="https://cdn1.iconfinder.com/data/icons/world-flags-circular/1000/Flag_of_United_Kingdom_-_Circle-64.png")/
                .label English
            .item(@click="store.set({key: 'selectedLang', value: 'pt_br'})", :class="store.get('selectedLang') == 'pt_br' ? 'selected' : ''")
                .img
                    img(src="https://cdn4.iconfinder.com/data/icons/world-flags-circular/1000/Flag_of_Brazil_-_Circle-256.png")/
                .label Português
            .item(@click="store.set({key: 'selectedLang', value: 'jp'})", :class="store.get('selectedLang') == 'jp' ? 'selected' : ''")
                .img
                    img(src="https://cdn3.iconfinder.com/data/icons/o-shaped-flag-1/128/O_shaped_asian_flag-16-64.png")/
                .label 日本
            .item(@click="store.set({key: 'selectedLang', value: 'ru'})", :class="store.get('selectedLang') == 'ru' ? 'selected' : ''")
                .img
                    img(src="https://cdn3.iconfinder.com/data/icons/o-shaped-flag-1/128/O_shaped_asian_flag-35-64.png")/
                .label Pусский
            .item(@click="store.set({key: 'selectedLang', value: 'es'})", :class="store.get('selectedLang') == 'es' ? 'selected' : ''")
                .img
                    img(src="https://cdn4.iconfinder.com/data/icons/world-flags-12/512/Untitled-2-05-64.png")/
                .label Español
            .item(@click="store.set({key: 'selectedLang', value: 'it'})", :class="store.get('selectedLang') == 'it' ? 'selected' : ''")
                .img
                    img(src="https://cdn1.iconfinder.com/data/icons/european-country-flags/83/italy-64.png")/
                .label Italiano
            ...
            .main-window
                ...
                Transition(name="fade")
                    .stage-1
                        .content-column.animated.fadeIn.delay-4s
                            ...
                            .networks
                                div {{ this.store.translate("prototype", "onboarding", "stage-1", "compatibility") }}
                                div 
                        ...
                        .content-column.animated.fadeIn.delay-4s
                            .items
                                .select-option-item.animated.fadeInUp.delay-3-5s
                                    ...
                                    .label 
                                        .title  {{ this.store.translate("prototype", "onboarding", "stage-1", "title-1") }}
                                        .desc {{ this.store.translate("prototype", "onboarding", "stage-1", "desc-1") }}
                                    button.primary(@click="showModalWords = true; createOrRestore = 'create'; changeStageTo(2, false);") {{ this.store.translate("prototype", "onboarding", "stage-1", "button-1") }}
                                hr/
                                .select-option-item.animated.fadeInUp.delay-3-7s
                                    ...
                                    .label 
                                        .title {{ this.store.translate("prototype", "onboarding", "stage-1", "title-2") }}
                                        .desc {{ this.store.translate("prototype", "onboarding", "stage-1", "desc-2") }}
                                    button.primary {{ this.store.translate("prototype", "onboarding", "stage-1", "button-2") }}
                                hr/
                                .select-option-item.animated.fadeInUp.delay-3-9s
                                    ...
                                    .label 
                                        .title {{ this.store.translate("prototype", "onboarding", "stage-1", "title-3") }}
                                        .desc {{ this.store.translate("prototype", "onboarding", "stage-1", "desc-3") }}
                                    button.primary(@click="showModalWords = false; createOrRestore = 'restore'; popupRestore = true;") {{ this.store.translate("prototype", "onboarding", "stage-1", "button-3") }}
                Transition(name="fade")
                            ...
                            .content-column
                                .timeline 
                                    .point.animated.fadeInUp.delay-0-5s(:class="stage >= 3 ? 'path-done' : ''")
                                        .selection.selected
                                        .label  {{this.store.translate("prototype", "onboarding", "timeline", "item-1")}}
                                    .point.animated.fadeInUp.delay-0-6s(:class="stage >= 4 ? 'path-done' : ''")
                                        .selection(:class="stage >= 3 ? 'selected' : ''")
                                        .label {{this.store.translate("prototype", "onboarding", "timeline", "item-2")}}
                                    .point.animated.fadeInUp.delay-0-7s(:class="stage >= 5 ? 'path-done' : ''")
                                        .selection(:class="stage >= 4 ? 'selected' : ''")
                                        .label {{this.store.translate("prototype", "onboarding", "timeline", "item-3")}}
                                    .point.animated.fadeInUp.delay-0-8s
                                        .selection(:class="stage >= 5 ? 'selected' : ''") 
                                        .label {{this.store.translate("prototype", "onboarding", "timeline", "item-4")}}
                            
                            .content-column.animated.fadeIn.delay-1s
                                //- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                                .content-stage(v-if="stage == 2", style="position: relative;")
                                    h2 {{this.store.translate("prototype", "onboarding", "stage-2", "title")}}
                                    div {{this.store.translate("prototype", "onboarding", "stage-2", "desc")}}
                                    .clear(style="height: 30px;")
                                    .buttons-terms
                                        .item-term(@click="modalTerms = true")
                                            .label {{this.store.translate("prototype", "onboarding", "stage-2", "item-terms")}}
                                            .chevron
                                        ...
                                        .item-term(@click="modalPrivacy = true")
                                            .label {{this.store.translate("prototype", "onboarding", "stage-2", "item-privacy")}}
                                            .chevron
                                                <svg width="1em" height="12px" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="SocialLink-module_arrow__II2PS"><path fill-rule="evenodd" clip-rule="evenodd" d="M.293 9.707a1 1 0 0 1 0-1.414L3.586 5 .293 1.707A1 1 0 0 1 1.707.293l4 4a1 1 0 0 1 0 1.414l-4 4a1 1 0 0 1-1.414 0Z" fill="currentColor"></path></svg>
                                    .content-section
                                        ...
                                        div 
                                            label.terms-input(:style="!termsChecked ? 'background-color: transparent;' : ''")
                                                span
                                                    ...
                                                    span {{this.store.translate("prototype", "onboarding", "stage-2", "accept-the-terms")}}
                                                .info(v-if="!termsChecked")
                                                    ...
                                                    span.required-label {{this.store.translate("prototype", "onboarding", "stage-2", "terms-required")}}
                                    ...
                                    .overlay-terms(v-if="modalTerms || modalPrivacy")
                                        ...
                                        .scrollable(v-if="modalPrivacy")
                                            ...
                                            div.title-know-more 
                                                pre {{this.store.translate("prototype", "onboarding", "stage-2", "full-privacy")}}
                                                //- ul 
                                                    li 
                                                        span
                                ...
                                .content-stage.animated.toggleInUp(v-if="stage == 3")
                                    h2 {{ this.store.translate("prototype", "onboarding", "stage-3", "title") }}
                                    br/
                                    .content-section
                                        span {{ this.store.translate("prototype", "onboarding", "stage-3", "choose-a-wallet-name") }}
                                        label
                                            input(type="text", :placeholder='this.store.translate("prototype", "onboarding", "placeholder", "wallet-name")', v-model="walletName")/
                                    br/
                                    span  {{ this.store.translate("prototype", "onboarding", "stage-3", "setup-password") }}
                                    .content-section.passwd
                                        label
                                            input(type="password", :placeholder='this.store.translate("prototype", "onboarding", "placeholder", "password")', v-model="password")/
                                            ...
                                            span(v-if="password.length > 0")
                                                .feedback-passwd(:class="password.length < 3 ? 'red' : 'green'") 
                                                    ...
                                                    span {{ this.store.translate("prototype", "onboarding", "stage-3", "password-validation-1") }}
                                                .feedback-passwd(:class="password.length < 5 ? 'red' : 'green'") 
                                                    ...
                                                    span {{ this.store.translate("prototype", "onboarding", "stage-3", "password-validation-2") }}
                                                .feedback-passwd.green(:class="password.length < 7 ? 'red' : 'green'") 
                                                    ...
                                                    span {{ this.store.translate("prototype", "onboarding", "stage-3", "password-validation-3") }}
                                        label
                                            input(type="password", :placeholder='this.store.translate("prototype", "onboarding", "placeholder", "confirm-password")', v-model="checkpassword")/
                                            <svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="ant-input-password-icon" data-testid="password-input-show-icon"><path fill-rule="evenodd" clip-rule="evenodd" d="M3.512 12a9.004 9.004 0 0 0 16.977 0 9.004 9.004 0 0 0-16.977 0Zm-2.008-.3C2.906 7.238 7.074 4 12 4c4.927 0 9.095 3.238 10.497 7.7a1 1 0 0 1 0 .6C21.095 16.762 16.927 20 12 20c-4.927 0-9.095-3.238-10.497-7.7a1 1 0 0 1 0-.6ZM12 10a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm-4 2a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z" fill="#878E9E"></path></svg>
                                            ...
                                            .feedback-passwd(v-if="checkpassword.length > 0")
                                                ...
                                                span
                                                    span.red(v-if="checkpassword.length < 5") {{ this.store.translate("prototype", "onboarding", "stage-3", "password-validation-4") }}
                                                    span.green(v-if="checkpassword.length >= 5") {{ this.store.translate("prototype", "onboarding", "stage-3", "password-validation-4") }}
                                //- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

                                //- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                                .content-stage.animated.toggleInUp(v-if="stage == 4")
                                    h2(v-show="createOrRestore == 'create' && showModalWords") {{ this.store.translate("prototype", "onboarding", "stage-4", "title") }}
                                    h2(v-show="createOrRestore == 'create' && !showModalWords") {{ this.store.translate("prototype", "onboarding", "stage-4", "title") }}
                                    h2(v-show="createOrRestore == 'restore'") {{ this.store.translate("prototype", "onboarding", "stage-4", "title") }}
                                    .content-section
                                        span(v-show="createOrRestore == 'create' && showModalWords") {{ this.store.translate("prototype", "onboarding", "stage-4", "desc") }}
                                        span(v-show="createOrRestore == 'create' && !showModalWords") {{ this.store.translate("prototype", "onboarding", "stage-5", "desc") }}
                                        span(v-show="createOrRestore == 'restore'") {{ this.store.translate("prototype", "onboarding", "stage-5", "desc") }}
                                    ...
                                    .tabs 
                                        .tab(@click="tabRecovery = 1;", :class="tabRecovery == 1 ? 'active' : ''") {{ this.store.translate("prototype", "onboarding", "stage-5", "passphrase-type-1") }}
                                        .tab(@click="tabRecovery = 2;", :class="tabRecovery == 2 ? 'active' : ''") {{ this.store.translate("prototype", "onboarding", "stage-5", "passphrase-type-2") }}
                                        .tab(@click="tabRecovery = 3;", :class="tabRecovery == 3 ? 'active' : ''") {{ this.store.translate("prototype", "onboarding", "stage-5", "passphrase-type-3") }}
                                ...
                                .content-stage.animated.toggleInUp(v-if="stage == 5")
                                    h2 {{ this.store.translate("prototype", "onboarding", "stage-6", "title") }}
                                    .content-section
                                        span {{ this.store.translate("prototype", "onboarding", "stage-6", "desc") }}
                                        ...
                                        .follow 
                                            ...
                                            span {{ this.store.translate("prototype", "onboarding", "stage-6", "twitter") }}
                                            .chevron
                                                <svg width="1em" height="12px" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="SocialLink-module_arrow__II2PS"><path fill-rule="evenodd" clip-rule="evenodd" d="M.293 9.707a1 1 0 0 1 0-1.414L3.586 5 .293 1.707A1 1 0 0 1 1.707.293l4 4a1 1 0 0 1 0 1.414l-4 4a1 1 0 0 1-1.414 0Z" fill="currentColor"></path></svg>
                                        .follow 
                                            .ico 
                                            ...
                                            span {{ this.store.translate("prototype", "onboarding", "stage-6", "youtube") }}
                                            .chevron
                                                <svg width="1em" height="12px" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="SocialLink-module_arrow__II2PS"><path fill-rule="evenodd" clip-rule="evenodd" d="M.293 9.707a1 1 0 0 1 0-1.414L3.586 5 .293 1.707A1 1 0 0 1 1.707.293l4 4a1 1 0 0 1 0 1.414l-4 4a1 1 0 0 1-1.414 0Z" fill="currentColor"></path></svg>
                                        .follow 
                                            .ico 
                                            ...
                                            span {{ this.store.translate("prototype", "onboarding", "stage-6", "discord") }}
                                            .chevron
                                                <svg width="1em" height="12px" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="SocialLink-module_arrow__II2PS"><path fill-rule="evenodd" clip-rule="evenodd" d="M.293 9.707a1 1 0 0 1 0-1.414L3.586 5 .293 1.707A1 1 0 0 1 1.707.293l4 4a1 1 0 0 1 0 1.414l-4 4a1 1 0 0 1-1.414 0Z" fill="currentColor"></path></svg>
                                //- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                                    
                                .button-area.fadeIn.delay-1s
                                    button.tertiary(v-if="!modalTerms && !modalPrivacy", @click="changeStageTo('back')") {{ this.store.translate("prototype", "onboarding", "timeline", "btn-previous") }} 
                                    button.tertiary(v-if="modalTerms", @click="modalTerms = false; modalPrivacy = false;", style="white-space: nowrap; width: 540px;") {{this.store.translate("prototype", "onboarding", "stage-2", "full-terms-button")}}
                                    ...
                                    span(v-if="!modalTerms && !modalPrivacy")
                                        button.purple(v-if="(stage >= 2) && (!modalTerms && !modalPrivacy)", @click="(createOrRestore == 'create' ? (showModalWords = true) : (showModalWords = false)); changeStageTo('next')", :disabled="nextShouldBeEnabled()") 
                                            span(v-if="stage > 2 && stage != 5") {{ this.store.translate("prototype", "onboarding", "timeline", "btn-next") }}
                                            span(v-if="stage == 2 && stage != 5") {{ this.store.translate("prototype", "onboarding", "timeline", "btn-next") }}
                                            span(v-if="stage == 5") {{ this.store.translate("prototype", "onboarding", "timeline", "btn-go-to-wallet") }}
                ...
                Transition(name="fade")
                    .modal-restore-overlay(v-if="popupRestore")
                        .background-overlay 
                        .floating-window
                            .title {{ this.store.translate("prototype", "onboarding", "stage-1", "modal-title") }}
                            .desc {{ this.store.translate("prototype", "onboarding", "stage-1", "modal-desc") }}
                            .buttons 
                                button.tertiary(@click="popupRestore = false;") {{ this.store.translate("prototype", "onboarding", "timeline", "btn-previous") }} 
                                button.purple(@click="changeStageTo(2, false);") {{ this.store.translate("prototype", "onboarding", "timeline", "btn-continue") }}
                //- 
                //- 
                //- 
            //- 
